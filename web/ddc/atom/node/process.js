dart_library.library('atom/node/process', null, /* Imports */[
  ...
  class ProcessRunner extends core.Object {
    ...
    execSimple() {
      ...
      this.onStdout.listen(dart.fn(str => stdout.write(str), dart.void, [dart.dynamic]));
      this.onStderr.listen(dart.fn(str => stderr.write(str), dart.void, [dart.dynamic]));
      return dart.as(this.execStreaming().then(dart.fn(code => {
        return new ProcessResult(dart.as(code, core.int), dart.toString(stdout), dart.toString(stderr));
      })), async.Future$(ProcessResult));
    }
    execStreaming() {
      if (this[_process] != null) dart.throw(new core.StateError('exec can only be called once'));
      try {
        this[_process] = atom.BufferedProcess.create(this.command, {args: this.args, cwd: this.cwd, env: this.env, stdout: dart.fn(s => this[_stdoutController].add(dart.as(s, core.String)), dart.void, [dart.dynamic]), stderr: dart.fn(s => this[_stderrController].add(dart.as(s, core.String)), dart.void, [dart.dynamic]), exit: dart.fn(code => {
            this[_exit] = dart.as(code, core.int);
            if (!dart.notNull(this[_exitCompleter].isCompleted)) this[_exitCompleter].complete(code);
          }), onWillThrowError: dart.fn(e => {
