dart_library.library('logging/logging', null, /* Imports */[
  ...
  let _level = Symbol('_level');
  let _controller = Symbol('_controller');
  let _getStream = Symbol('_getStream');
  let _publish = Symbol('_publish');
  class Logger extends core.Object {
    ...
    log(logLevel, message, error, stackTrace, zone) {
      ...
      if (dart.notNull(this.isLoggable(logLevel))) {
        if (dart.is(message, core.Function))
  ...
  let LoggerHandler = dart.typedef('LoggerHandler', () => dart.functionType(dart.void, [dart.dynamic]));
