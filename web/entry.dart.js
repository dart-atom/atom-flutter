...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    getSystemDescription: function() {
      ...
      return Q.Dependencies_instance().getDependency$1(C.Type_AtomPackage_0N5).getPackageVersion$0().then$1(new T.getSystemDescription_closure(atomVer, os));
    },
    GettingStarted: {
      "^": "Object;disposables",
      dispose$0: [function() {
