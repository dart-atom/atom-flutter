...
// Generated by dart2js (CSP), the Dart to JavaScript compiler version: 1.20.0-dev.7.0.
...
(function() {
  ...
  init.precompiled = function($collectedClasses$) {
    ...
    function ListIterator(_iterable, _length, _index, _current, $ti) {
    ...
    function MappedIterator(_current, _iterator, _f, $ti) {
      this._current = _current;
    ...
    function MappedListIterable(__internal$_source, _f, $ti) {
    ...
    function ReversedListIterable(__internal$_source, $ti) {
      this.__internal$_source = __internal$_source;
      this.$ti = $ti;
      this.$deferredAction();
    }
    ...
    function ConstantMapView(_map, $ti) {
      this._map = _map;
      this.$ti = $ti;
      this.$deferredAction();
    }
    ...
    function ConstantStringMap(__js_helper$_length, __js_helper$_jsObject, _keys, $ti) {
    ...
    function _ConstantMapKeyIterable(__js_helper$_map, $ti) {
    ...
    function JsLinkedHashMap(__js_helper$_length, _strings, _nums, _rest, _first, _last, _modifications, $ti) {
      this.__js_helper$_length = __js_helper$_length;
    ...
    function LinkedHashMapKeyIterable(__js_helper$_map, $ti) {
      this.__js_helper$_map = __js_helper$_map;
      this.$ti = $ti;
      this.$deferredAction();
    }
    ...
    function LinkedHashMapKeyIterator(__js_helper$_map, _modifications, _cell, __js_helper$_current, $ti) {
      this.__js_helper$_map = __js_helper$_map;
      this._modifications = _modifications;
      this._cell = _cell;
    ...
    function _MapStream(_transform, _source, $ti) {
    ...
    function _HandleErrorStream(_transform, _test, _source, $ti) {
      this._transform = _transform;
      this._test = _test;
      this._source = _source;
      this.$ti = $ti;
    ...
    function _HashMapKeyIterable(_map, $ti) {
      this._map = _map;
      this.$ti = $ti;
      this.$deferredAction();
    }
    ...
    function _HashMapKeyIterator(_map, _collection$_keys, _offset, _collection$_current, $ti) {
      this._map = _map;
      this._collection$_keys = _collection$_keys;
    ...
    function _LinkedIdentityHashMap(__js_helper$_length, _strings, _nums, _rest, _first, _last, _modifications, $ti) {
      this.__js_helper$_length = __js_helper$_length;
      this._strings = _strings;
      this._nums = _nums;
      this._rest = _rest;
    ...
    MapView.$__fields__ = [];
    function UnmodifiableMapView(_map, $ti) {
      this._map = _map;
      this.$ti = $ti;
      this.$deferredAction();
    }
    ...
    function _ListQueueIterator(_queue, _end, _modificationCount, _position, _collection$_current, $ti) {
      this._queue = _queue;
      this._end = _end;
      this._modificationCount = _modificationCount;
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    LinkedHashMapKeyIterator: {
      "^": "Object;__js_helper$_map,_modifications,_cell,__js_helper$_current,$ti",
      get$current: function() {
    ...
    Future_forEach: function(input, f) {
      var iterator = new P._LinkedHashSetIterator(input, input._collection$_modifications, null, null, [null]);
    ...
    _HandleErrorStream: {
      "^": "_ForwardingStream;_transform,_test,_source,$ti",
      _handleError$3: function(error, stackTrace, sink) {
    ...
    _HashMapKeyIterator: {
      "^": "Object;_map,_collection$_keys,_offset,_collection$_current,$ti",
      get$current: function() {
    ...
    Workspace: {
      ...
      open$2$options: function(_, url, options) {
        ...
        t3 = t1._operations;
        t3.push(new Y.Workspace_open_closure(this, url, options));
        t1._completers.push(new P._AsyncCompleter(t2, [null]));
        if (t3.length === 1)
          t1._serviceQueue$0();
        return t2;
      },
    ...
    UsageManager__init_closure: {
      ...
      call$1: [function(version) {
        ...
        t2.push(new P._BroadcastStream(t1, [H.getTypeArgumentByIndex(t1, 0)]).listen$1(G.usage__trackCommand$closure()));
    ...
    sanitizeStacktrace: function(st, shorten) {
      var str, t1, t2, iter, match, replacement;
      str = H.S(st);
      t1 = $.$get$_pathRegex();
      t1.toString;
      H.checkString(str);
      H.checkInt(0);
      t1 = P.List_List$from(new H._AllMatchesIterable(t1, str, 0), true, P.Match);
