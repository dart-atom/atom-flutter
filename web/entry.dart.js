...
// Generated by dart2js (CSP), the Dart to JavaScript compiler version: 1.14.0-dev.6.0.
...
(function() {
  ...
  init.precompiled = function($collectedClasses$) {
    ...
    function _AnalyticsAtom(trackingId, properties, postHandler, _bucket, _variableMap, _futures) {
    ...
    _AnalyticsAtom.$__fields__ = ["trackingId", "properties", "postHandler", "_bucket", "_variableMap", "_futures"];
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    CommandRegistry_add_closure: {
      ...
      call$1: [function(e) {
        ...
        this.callback.call$1(new E.AtomEvent(E._cvt(e)));
    ...
    main_closure: {
      ...
      call$1: [function(r) {
        var tag, t1;
        tag = "[" + r.get$level().name.toLowerCase() + " - " + r.get$loggerName() + "] ";
    ...
    GettingStarted__handleSendFeedback_closure: {
      ...
      call$1: [function(description) {
        $.$get$shell().invoke$2("openExternal", "https://github.com/flutter/atom-flutter/issues/new?body=" + H.S(P.Uri__uriEncode(C.List_KIf, description, C.Utf8Codec_false, false)));
    ...
    UsageManager__init__closure: {
      ...
      call$1: [function(value) {
        ...
        if (J.$eq$(value, true)) {
          t1 = this.version;
          t2 = new Z.ThrottlingBucket(20, null, null);
          t2.drops = 20;
          t2._lastReplenish = Date.now();
          t2 = new G._AnalyticsAtom("UA-67589403-3", new G._AtomUsagePersistentProperties("flutter"), new G._AtomUsagePostHandler(), t2, P.LinkedHashMap__makeEmpty(), []);
          t2.setSessionValue$2("an", "flutter");
          if (t1 != null)
            t2.setSessionValue$2("av", t1);
          $._ga = t2;
          t2.set$optIn(true);
    ...
    _AnalyticsAtom: {
      "^": "AnalyticsImpl;trackingId,properties,postHandler,_bucket,_variableMap,_futures"
    },
    _AtomUsagePersistentProperties: {
    ...
    _postEncode_closure: {
      ...
      call$1: [function(key) {
        var value, t1;
        value = H.S(this.map.$index(0, key));
        t1 = H.S(key) + "=";
        H.checkString("%20");
        return t1 + H.stringReplaceAllUnchecked(value, " ", "%20");
...
;
  ...
  }, "process", "$get$process", "process", function() {
  ...
  }, "_pathRegex", "$get$_pathRegex", "_pathRegex", function() {
