...
// Generated by dart2js (CSP), the Dart to JavaScript compiler version: 1.15.0-dev.0.0.
...
(function() {
  ...
  init.precompiled = function($collectedClasses$) {
    ...
    Future.$__fields__ = [];
    function closure1(computation, result) {
    ...
    closure1.$__fields__ = ["computation", "result"];
    ...
    closure0.$__fields__ = ["shellEscape"];
    function _closure() {
      this.$deferredAction();
    }
    ...
    $desc = $collectedClasses$._closure[1];
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    stringReplaceAllFuncUnchecked: function(receiver, pattern, onMatch, onNonMatch) {
      ...
      buffer = new P.StringBuffer("");
      for (t1 = pattern.allMatches$1(0, receiver), t1 = new H._AllMatchesIterator(t1._re, t1._string, t1._start, null), startIndex = 0; t1.moveNext$0();) {
    ...
    registerPackage_closure: {
      ...
      }, "call$0", null, null, null, 0, 2, null, 3, 19, "call"]
    },
    ...
    install: function(packageLabel, $package, justNotify) {
      return $package.loadPackageJson$0().then$1(new Q.install_closure(packageLabel, true));
    },
    _installPackage: [function($name) {
      ...
      return X.ProcessRunner_ProcessRunner$underShell(t1._packages.invoke$1("getApmPath"), ["--no-color", "install", $name], null, null).execSimple$0().then$1(new Q._installPackage_closure($name)).then$1(new Q._installPackage_closure0($name)).catchError$1(new Q._installPackage_closure1($name));
    }, "call$1", "package_deps___installPackage$closure", 2, 0, 29],
    install_closure: {
      "^": "Closure:6;packageLabel,justNotify",
    ...
    }, "call$2", "call$1", "async___nullErrorHandler$closure", 2, 2, 8, 3, 0, 4],
    ...
    _Completer: {
      ...
      }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 19, 3, 0, 4]
    },
    _AsyncCompleter: {
      "^": "_Completer;future",
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 8, 3, 0, 4],
    ...
    _Future__chainForeignFuture_closure0: {
      ...
      }, "call$1", null, null, null, 2, 2, null, 3, 0, 4, "call"]
    },
    _Future__chainForeignFuture_closure1: {
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 22, 0, 4],
    ...
    FlutterDevPackage_activate_closure: {
      "^": "Closure:0;$this",
      call$0: function() {
        Q.install("Flutter", this.$this, true);
      }
    }
    ...
    Process: {
      ...
      env$1: function(key) {
        var t1, exception;
        try {
          t1 = J.$index$asx(J.$index$asx(this.obj, "env"), key);
          return t1;
        } catch (exception) {
          H.unwrapException(exception);
          return;
    ...
    closure0: {
      "^": "Closure:3;shellEscape",
      call$1: [function(arg) {
        return "'" + J.replaceAllMapped$2$s(arg, this.shellEscape, new X._closure()) + "'";
      }, null, null, 2, 0, null, 6, "call"]
    },
    _closure: {
      "^": "Closure:27;",
    ...
    sanitizeStacktrace: function(st, shorten) {
      var str, iter, t1, match, replacement, t2;
      str = H.S(st);
    ...
    }, "call$1", "usage__trackCommand$closure", 2, 0, 30, 38],
    ...
    }, "call$1", "usage___handleLogRecord$closure", 2, 0, 31, 39],
    ...
    _postEncode_closure: {
      ...
      call$1: [function(key) {
        ...
        return H.S(key) + "=" + C.JSString_methods.replaceAll$2(value, " ", "%20");
...
;
  ...
  $ = new Isolate();
  init.metadata = ["error", "e", "_", null, "stackTrace", "o", "arg", "str", "x", "s", "code", "data", "element", "value", "object", "invocation", "result", "map", "info", "state", "numberOfArguments", "each", "arg4", "arg3", "arg2", "arg1", "xhr", "key", "captureThis", "self", "arguments", "sender", "r", "description", "pluginVer", "errorCallback", "isolate", "closure", "command", "log", "version", "callback"];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, args: [P.String]}, {func: 1, args: [,,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [P.Map]}, {func: 1, args: [P.bool]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, v: true, args: [E.AtomEvent]}, {func: 1, ret: P.Object, args: [,]}, {func: 1, args: [P.String,,]}, {func: 1, args: [, P.String]}, {func: 1, opt: [,]}, {func: 1, args: [P.JsObject]}, {func: 1, args: [P.String, K.StateStorable]}, {func: 1, args: [X.ProcessResult]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [P.Symbol,,]}, {func: 1, args: [W.HttpRequest]}, {func: 1, args: [N.LogRecord]}, {func: 1, v: true, args: [{func: 1, v: true, args: [,]}]}, {func: 1, args: [P.Match]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: P.Future, args: [P.String]}, {func: 1, v: true, args: [P.String]}, {func: 1, v: true, args: [N.LogRecord]}];
